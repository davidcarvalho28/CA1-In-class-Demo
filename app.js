...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('HardWater.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('HardWater.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('HardWater.xml', function(err, result) {
      if (err) throw (err);
      ...
      jsToXmlFile('HardWater.xml', result, function(err) {
